...
var _Critters = __webpack_require__(36);

var _Critters2 = _interopRequireDefault(_Critters);
...
class Main extends _react.Component {
  ...
  selectCritters(critterName) {
    _axios2.default.get(`/api/${critterName}`).then(res => res.data).then(critters => {
  ...
  render() {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_Navbar2.default, { selectCritters: this.selectCritters }),
      _react2.default.createElement(_Critters2.default, { critters: this.state.critters, title: 'my critters:' })
    );
  }
}
...
const Navbar = props => {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "button",
      { id: "dogs", onClick: () => selectCritters('dogs') },
      "Dogs"
    ),
    _react2.default.createElement(
      "button",
      { id: "cats", onClick: () => selectCritters('cats') },
      "Cats"
    ),
    _react2.default.createElement(
      "button",
      { id: "dragons", onClick: () => selectCritters('dragons') },
      "Dragons"
    )
  );
};
  ...
  return _react2.default.createElement(
    ...
    props.critters.map(critter => {
      return _react2.default.createElement(
        ...
        _react2.default.createElement("img", { src: critter.image })
      );
    })
  );
};
